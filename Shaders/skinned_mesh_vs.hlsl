...
VS_OUT main(float4 position : POSITION, float4 normal : NORMAL,float2 texcoord : TEXCOORD, float4 bone_weights : WEIGHTS/*UNIT.20*/, uint4  bone_indices : BONES/*UNIT.20*/)
{
    // UNIT.21
    float3 p = { 0, 0, 0 };
    float3 n = { 0, 0, 0 };
