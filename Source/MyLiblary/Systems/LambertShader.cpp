...
void LambertShader::Activate(ID3D11DeviceContext* context, const RenderContext& render_context)
{
	...
	DirectX::XMFLOAT4X4 view_projection{};
	{
		...
		V = DirectX::XMLoadFloat4x4(&render_context.view);
		P = DirectX::XMLoadFloat4x4(&render_context.projection);
		VP = V * P;
		DirectX::XMStoreFloat4x4(&view_projection, VP);
	}
	constant_buffer_scene.view_projection = view_projection;
	constant_buffer_scene.light_direction = render_context.light_direction;
...
void LambertShader::Deactivate(ID3D11DeviceContext* context)
{
